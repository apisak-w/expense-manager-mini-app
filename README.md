...
- `pages:deploy`. Deploys the application to Cloudflare Pages.
...
This project also supports deployment to [Cloudflare Pages](https://pages.cloudflare.com/).
...
A [GitHub workflow](.github/workflows/cloudflare-pages-deploy.yml) is provided to automatically deploy to Cloudflare Pages on pushes to the `master` branch.
